 ...
 *
 * @version 1.13 c5131-nRF24L01-demo-receiver-1_0_0 $Id: scsi_decoder.h,v 1.13 2005/07/06 13:40:48 lguilhau Exp $
 *
 * @todo
 * @bug
 */
...
//! One status shall be sent at the end of scsi command
// The status are define in norme SAM-3 §5.3.1 :
//           00h GOOD Yes TASK COMPLETE
//           02h CHECK CONDITION Yes TASK COMPLETE
// NO USED - 04h CONDITION MET Yes TASK COMPLETE
//           08h BUSY Yes TASK COMPLETE
// USE DFC - 10h INTERMEDIATE No LINKED COMMAND COMPLETE
// NO USED - 14h INTERMEDIATE-CONDITION MET No LINKED COMMAND COMPLETE
// NO USED - 18h RESERVATION CONFLICT Yes TASK COMPLETE
// NO USED - 28h TASK SET FULL Yes TASK COMPLETE
// NO USED - 30h ACA ACTIVE Yes TASK COMPLETE
...
#define Sbc_valid_write_usb(length)          {Usb_send_in(); g_scsi_data_remaining -= length;}
